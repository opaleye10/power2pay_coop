        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>General Ledger Main Account</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" ></div>
                                 <form class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <select name="glmainacct" id="glmainacct" onchange="getGlhead(this.value)">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword3">ID</label>
                                            <input type="text" class="form-control" size="4" name="subid" id="subid" placeholder="Code" enabled="false" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword3">ID</label>
                                            <input type="text" class="form-control" size="50"  name="glaccthead" id="glaccthead" placeholder="GL Account Head Description" enabled="false" required>
                                        </div>
                                        <button type="button" name="SaveMainAcctHead" id="SaveMainAcctHead" style="font-size:16px"><i class="fa fa-save"></i> Save </button>
                                ...
                                <script>
                                    function getGlhead(val) {
                                       ...
                                       // $('#snackbar').show();
                                        ...
                                        $.ajax({
                                            type: 'post',
                                            url: 'https://app.power2pay.com.ng/models/getaccounthead.php',
                                            data: {mainid: glid},
                                            success: function (o) {
                             ...
                             //   print_r($this->GetGlsubAcctintable);
                                $myrecords=($this->GetGlsubAcctintable);
                                ?>
                                <table class="blueTable">
                                 ...
                                 //   foreach ($myrecords as $Key => $Value) {
                                  //  echo '<tr>
                                   //     <td>'.$Value['mainid'].'</td><td>'.$Value['subid'].'</td><td>'.$Value['sub_desc'].'</td></tr>';
                                   // }
