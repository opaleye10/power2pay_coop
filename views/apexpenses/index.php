                ...
                <div class="content-graph">
                    ...
                    <div class="graph-container">
                        ...
                        <div class="grid-form1">
                            ...
                            <div  id="snackbar" class="alert alert-danger" role="alert" >COMPANY EXPENSES REPORTS</div>
                                ...
                                <br/>
                            <div id="daterange"> 
                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>apexpenses/expensesdaterange">

                                    From : <input type="date" name="dfrom" id="dfrom"  size="13"  ng-model="model.date" required="">
                                    To: <input type="date" name="dto" id="dto"  size="13"  ng-model="model.date" required=""><br/>
                                    <select>
                                ...
                                <div id="allperiod">
                                <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>apexpenses/expenseallperiod">
                                    <select  class="form-control"  name="speriod" id="speriod" onchange="getInfo(this.value)">
                                                <option value disabled selected>Select Period</option>
                                                 <?php
                                                foreach($this->GetPeriod as $module) {
                                                    ?>
