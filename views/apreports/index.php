        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Account Payables : Reports</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >PROCESSED AP REPORTS</div>                             
                                     
                                    <center> <div class="form-group" style="align-items: center;">                                            
                                            <a href="<?php echo URL.'apexpenses' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Expenses/AH Reports </button></a>                                           
