...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="content-main">
                        ...
                        <div class="grid-form1">
                            ...
                            <div  id="snackbar" class="alert alert-danger" role="alert" ></div>
                                         ...
                                         <label class="control-label ">Bank</label>
                                            <select name="bank" id="bank" >
                                                ...
                                                foreach($this->GetBanklist as $module) {
                                                    ?>
                                                    <option value="<?php echo $module["id"]; ?>"><?php echo $module["banks"]; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                ...
                                <div class="col-md-12 form-group1 group-mail">
                                    <label class="control-label ">POS Description:</label>
                                    <input type="text" class="form-control"  name="posname" id="posname" placeholder="POS Description" required>                                   
                                </div>
                                <div class="col-md-12 form-group1 group-mail">
                                    <label class="control-label ">Account Number</label>
                                    <input type="text" class="form-control"  name="acctno" id="acctno" placeholder="acctno" required>                                   
                                </div>
                                <div class="col-md-12 form-group2 group-mail">
                                         <label class="control-label ">GL AccountID</label>
                                            <select name="accountid" id="accountid" >
                                                <option value disabled selected>Select GL AccountID</option>                                    <?php
                                ...
                                <div class="clearfix"> </div>
                                 <button name="SaveBanks" id="SaveBanks" style='font-size:20px'><i class='fa fa-save'></i> Save POST BANK </button>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                                        <?php
                                           //print_r($this->Getposbanklist);
                                        $myrecords=($this->Getposbanklist);
                                        ?>
                                        <table  class="blueTable" style="width: 100%">
                                            <thead>
                                            <tr>

                                                <th style="width: 40%; text-align: left">POS Description</th>
                                                <th style="width: 30%; text-align: left" >Bank</th>
                                                <th style="width: 30%; text-align: left">Account No.</th>
                                            ...
                                            <?php
                                              foreach ($myrecords as $Key => $Value) {
                                                echo '<tr>
                                            <td>'.$Value['posname'].'</td><td>'.$Value['bank'].'</td><td>'.$Value['acctno'].'</td></tr>';
                                            }
                                            ?>
                                            </tbody>
                                            </tr>
