                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >SALARY BANK SUMMARY REPORT
                                </div>                              
                                     
                                    <center> <div class="form-group" style="align-items: center;">
                                    <form method="post" enctype="multipart/form-data" action="<?php echo URL ;?>banksummary/displaybanksummary">
                                        <select name="period" id='period'>
                                            ...
                                            <button type="submit"  style="font-size:16px"><i class="fa fa-process"></i> Display Bank Summary </button>                                            
                                        </div></center>
                                        </form>
