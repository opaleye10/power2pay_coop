                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >Salary Variation Setup</div>
                                    <div class="form-group">                                        
                                    <div class="form-group">
                                    <input type="text" class="form-control"  name="vardesc" id="vardesc" placeholder="Variation Details"   required>
                                    <select  class="form-control" name="allwvar" id="allwvar" onchange="getdetails(this.value)">
                                            <option value disabled selected>Select Allw</option>                                    <?php
                                            foreach($this->GetSalaryAllw as $module) {
                                                ?>
                                                <option value="<?php echo $module["allwid"]; ?>"><?php echo $module["allwdesc"]; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    <div><input type="text" class="form-control"  name="varabbr" id="varabbr" placeholder="Variation Abbr"  required></div>
                                    <br/>
                                    <div>
                                        <select  class="form-control" name="glacct" id="glacct">
                                            <option value disabled selected>Select GL Account</option>                                    <?php
                                            foreach($this->GetGLaccountlike020101 as $modul) {
                                                ?>
                                                <option value="<?php echo $module["accountid"]; ?>"><?php echo $modul["gldescription"]; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <select  class="form-control" name="vtype" id="vtype">
                                                ...
                                                <label ><input class="form-control" type="checkbox" name="allowance" id="allowance">Allowance?</label> 
                                        <br/>
                                        <br/> <div class="form-group">
                                            <button type="button" name="savesubglacct" id="savesubglacct" style="font-size:16px"><i class="fa fa-save"></i> Save Variation </button>                                            
                                        </div>                                        
                                    </div>
