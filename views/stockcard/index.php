                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >STOCK CARD</div>
                                <form class="form-inline"  method="post" action="<?php echo URL . 'stockcard/printstockhistory' ;?>"  >
                                    <div class="form-group">
                                        <div class="form-group">
                                        <label class="control-label ">From :</label>
                                        <input type="date" name="dfrom" id="deldate"  size="13" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                    </div>
                                    <div class="form-group">
                                    <label class="control-label ">To: </label>
                                        <input type="date" name="dto" id="deldate"  size="13" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                    </div>
                                        ...
                                        <div class="col-md-12 form-group2 group-mail">
                                            <select name="glmainacct" id="glminacct" onchange="getIdLoadsub(this.value)">
                                                <option value disabled selected>Select Store Item</option>                                    <?php
                                                foreach($this->GetProductList as $module) {
                                                    ?>
                                                    <option value="<?php echo $module["pid"]; ?>"><?php echo $module["pname"]; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" size="8" name="mainid" id="mainid"  enabled="false" required>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" name="savesubglacct" id="savesubglacct" style="font-size:16px"><i class="fa fa-print"></i> Print Stockcard </button>                                            
                                        </div>
