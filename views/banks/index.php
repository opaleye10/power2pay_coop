                    ...
                    <div class="graph-container">
                        ...
                        <div class="grid-form1">
                            ...
                            <div  id="snackbar" class="alert alert-danger" role="alert" ></div>
                                ...
                                <div class="clearfix"> </div>
                                 <button name="SaveBanks" id="SaveBanks" style='font-size:20px'><i class='fa fa-save'></i> Save </button>
                                  <a href="<?php echo URL.'stockin/printdelivery/'. $id; ?>"> <button type="button"  size="30" id="SaveDelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Print Bank List</button></a>
                                  <a href="<?php echo URL.'posbank' ;?>"> <button type="button"  size="30" id="SaveDelivery" class="btn btn-default"> <i class="fa fa-share-square" aria-hidden="true"></i> Set POS Bank</button></a>
                                 <div>
                                    <?php
