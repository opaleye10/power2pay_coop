        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Inventory : Stock Re-Order Level Alert</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                                    ...
                                    <div>
                                        ...
                                        <table  class="blueTable" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 25%; text-align: right">Re-Order Qty</th>
                                                <th style="width: 25%; text-align: right">Actual Qty</th>
                                            ...
                                            <?php
                                             ...
                                             foreach ($this->Getitem2reorder as $Key => $Value) {
                                                echo '<tr>
                                            <td>'.$Value['stockno'].'</td><td>'.$Value['stock'].'</td><td style="text-align: right">'.$Value['roqty'].'</td><td style="text-align: right">'.$Value['aqty'].'</td></tr>';
                                            }
