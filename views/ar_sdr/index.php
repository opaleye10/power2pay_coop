                            ...
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >DETAILS SALES RECEIPT</div>                             
                                    ...
                                    <center> <div class="form-group" style="align-items: center;">
                                            ...
                                            <select name="possales" id="possales" onchange="getIdLoadsub(this.value)">
                                                <option value disabled selected>Select Delivery</option>                                    <?php
                                                foreach($this->Getpos as $module) {
                                                    ?>
                                                    <option value="<?php echo $module["tme"]; ?>"><?php echo $module["trnno"] .' Purchase by customer : '.$module["customers"]. ' ' .number_format($module["amount"]); ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <script>
                                            ...
                                            <button type="submit"  size="30" id="printdelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Print Receipt</button>
                                           </form>
                                            </center>
