                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >GENERATE INVENTORY REPORTS</div>                             
                                     
                                    <center> <div class="form-group" style="align-items: center;">
                                    
                                             <div class="col-md-12 form-group2 group-mail">
                                            <select name="deliveries" id="deliveries" onchange="getIdLoadsub(this.value)">
                                                <option value disabled selected>Select Delivery</option>                                    <?php
                                                foreach($this->GetDelivery as $module) {
                                                    ?>
                                                    <option value="<?php echo $module["tme"]; ?>"><?php echo $module["deliveryno"] .' Stock from '.$module["supplier"]. ' ' .number_format($module["amount"]); ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <script>
                                            function getIdLoadsub(val) {
                                                ...
                                                var glid = document.getElementById("deliveries").value;
                                                $('#mainid').val(glid);
                                               
                                            }
                                        </script> </div> 
                                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>inreports/printdelivery">
                                            <input type="hidden" id="mainid" name="mainid">
                                            <button type="submit"  size="30" id="printdelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Print Delivery Document</button>
                                           </form>
                                            </center>
