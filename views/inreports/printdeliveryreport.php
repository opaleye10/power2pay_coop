...
foreach ($this->mydelivery as $key => $value) {
	...
	Session::set('supplier',$value['supplier']);
...
require "libss/fpdf.php";
	...
	class myPDF extends FPDF{
		...
		function header(){		
			...
			$this->Cell(25,5,'Supplier No :',0,0);
			$this->Cell(34,5,Session::get('supplierid'),0,1);

			$this->Cell(189,10,'',0,1);
			

			$this->Cell(100,5,'From :',0,1);

			//billing address
			$this->Cell(10,5,'',0,0);
			$this->Cell(90,5,'SUPPLIER',0,1);
			$this->Cell(10,5,'',0,0);

			$this->Cell(90,5,Session::get('supplier'),0,1);
			$this->Cell(10,5,'',0,0);
			$this->Cell(90,5,'',0,1);
