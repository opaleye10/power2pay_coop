                                    ...
                                    <div>
                                        ...
                                        <table  class="blueTable" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 40%; text-align: center;" >Vendor/Supplier</th>
                                                <th style="width: 20%; text-align: center;">Delivery No</th>
                                            ...
                                            <tbody id="tbodyid">
                                            <?php
                                              foreach ($this->GetStockhead as $Key => $Value) {
                                                $link='<a href="'. URL.'stockdelivery/details/'. $Value['tme'].'"> <button>Approve</button></a>';
                                                $delete='<a href="'. URL.'stockdelivery/delete/'. $Value['tme'].'"> <button>Delete</button></a>';                                                
                                                echo '<tr>
                                            <td>'.$Value['deldate'].'</td><td>'.$Value['supplier'].'</td><td>'.$Value['deliveryno'].'</td><td style="text-align: right">'.number_format($Value['amount']).'</td></td><td>'. $link .'</td><td>'. $delete .'</td></tr>';
                                            }
                                            ?>
                                            </tbody>
                                            </tr>
