                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >PROCESSED GL REPORTS</div>                             
                                     
                                    <center> <div class="form-group" style="align-items: center;">
                                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>glreports/chartofaccount">
                                            <button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Chart of Account </button> 
                                            </form>                                           
                                        
                                            <a href="<?php echo URL.'aheadreport' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> AH Transaction Report </button></a>
                                            <a href="<?php echo URL.'gltrialbalance' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Trial Balance </button></a>

                                                <a href="<?php echo URL.'glprofitandloss' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Profit & Loss Acct </button></a>
                                            </center>
