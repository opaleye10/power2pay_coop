        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Inventory : Stock Re-Order Level</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                                ...
                                <form class="form-inline">                                   
                                    ...
                                    <br class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"   class="form-control" name="qty" id="qty" placeholder="Re-Order Qty"   style="text-align:right;" maxlength="8" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button"  size="30" id="SaveReorderlevel" class="btn btn-default"> <i class="fa fa-save"></i> Save Re-Order Level</button>
                                       <a href="<?php echo URL.'stockin/printdelivery/'. $id; ?>"> <button type="button"  size="30" id="SaveDelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Print Stock Re-Order Level List</button></a>
                                    </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <table  class="blueTable" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 20%; text-align: center;">Item No</th>
                                                <th style="width: 50%; text-align: center;" >Description</th>
                                                <th style="width: 30%; text-align: right">Re-Order Qty</th>
                                                <th></th>
