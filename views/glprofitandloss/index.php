        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>General Ledger : P and L Account</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >Profit and Loss Account</div>
                                <form class="form-inline"  method="post" action="<?php echo URL . 'glprofitandloss/printfile' ;?>"  >
                                    <div class="form-group">                                       
                                        
                                       <center> <select  class="form-control"  name="speriod" id="speriod" onchange="getInfo(this.value)">
                                            ...
                                            <button type="submit" name="printfile" id="printfile" style="font-size:16px"><i class="fa fa-print"></i> Generate P/L Report </button>                                            
                                       </center>
