                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >PROCESSED SALARY REPORT</div>                             
                                     
                                    <center> <div class="form-group" style="align-items: center;">
                                            <button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Staff List </button>                                            
                                        
                                            <a href="<?php echo URL.'banksummary' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Bank Summary </button></a>
                                            <a href="<?php echo URL.'bankschedule' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Bank Schedule </button></a></center>
