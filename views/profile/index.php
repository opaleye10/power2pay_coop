<?php
Session::init();
$myprofile=array($this->GetCompanyProfile);
//print_r($this->GetCompanyProfile);
//print_r($myprofile);
$companyname = $this->GetCompanyProfile["companyname"];
$companyadd = $this->GetCompanyProfile["companyaddress"];
$companymobile = $this->GetCompanyProfile["companymobile"];
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="content-main">
            ...
            <div class="grid-form1">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="companyAdd" id="companyAdd" placeholder="Contact Address" value="<?php echo $companyadd; ?>" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="companyMobiletelno" id="companyMobiletelno" placeholder="Mobile Tel. Number" value="<?php echo $companymobile; ?>" required>
                    </div>

                    <button type="submit" id="savecompanyprofile" class="btn btn-default btn-send">Save</button> <a href="<?php echo URL.'subprofile'; ?>"> <button type="submit" id="savecompanyprofile" class="btn btn-default btn-send">Create Subsidiary</button></a>
