<?php
Session::init();
foreach ($this->loadcode as $key => $value) {
    # code...
    $cash=$value['cash'];
        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Account Payables : Setup Account Codes</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >ACCOUNT CODES SETUP</div>
                                    ...
                                    <table class="blueTable">
                                        ...
                                        <tr> <select id="glcode">
                                          <option value disabled selected>Select GL Code</option>
                                                 <?php
                                                foreach($this->GetAccountlist as $module) {
                                                    ?>
                                        ...
                                        <tbody id="tbodyid">
                                        <tr><td>Cash</td><td>                 
                                        <input type="text" id="cash" name="cash" value="<?php echo $cash ;?>">


                                        </td>
                                        <td><button id="savecash">Update/Save</button>
                                        </td></tr>
                                        <tr><td>Creditor</td><td>                 
                                        <input type="text" id="creditor" name="creditor" value="<?php echo $creditor ;?>">


                                        </td>
                                        <td><button id="savecreditor">Update/Save</button>
                                        </td></tr>
                                         <tr><td>Debtor</td><td>                 
                                        <input type="text" id="debtor" name="debtor" value="<?php echo $debtor ;?>">


                                        </td>
                                        <td><button id="savedebtor">Update/Save</button>
                                        </td></tr>
                                         <tr><td>Delivery(Bank)</td><td>                 
                                        <input type="text" id="delivery" name="delivery" value="<?php echo $delivery ;?>">


                                        </td>
                                        <td><button id="savedelivery">Update/Save</button>
                                        </td></tr>
                                        ...
                                        <tr><td>Sales</td><td>                 
                                        <input type="text" id="sales" name="sales" value="<?php echo $sales ;?>">


                                        </td>
                                        <td><button id="sale">Update/Save</button>
                                        </td></tr>



                                        <tr><td>Cost of goods sold</td><td>                 
                                        <input type="text" id="cogs" name="cogs" value="<?php echo $cogs ;?>">


                                        </td>
                                        <td><button id="cog">Update/Save</button>
                                        </td></tr>


                                        <tr><td>Inventory</td><td>                 
                                        <input type="text" id="inventory" name="inventory" value="<?php echo $inventory ;?>">


                                        </td>
                                        <td><button id="inventor">Update/Save</button>
                                        </td></tr>
