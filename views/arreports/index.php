        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Account Receivables : Reports</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >PROCESSED AR REPORTS</div>                             
                                     
                                    <center> <div class="form-group" style="align-items: center;">
                                    <a href="<?php echo URL.'ar_sdr' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Sales Detail Receipts </button> </a>

                                    <a href="<?php echo URL.'salessummary' ;?>"><button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Sales Summary </button> </a>
