                        ...
                        <div class="grid-form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <script>
                                            function getRecord(val) {
                                              ...
                                              $.ajax({
                                                        type: 'post',
                                                        url: 'http://localhost:8080/finance/account/models/load_productbyid.php',
                                ...
                                <div class="col-md-12 form-group1 group-mail">
                                    ...
                                    <script>
                                            function getRecordDatabase(val) {
                                                ...
                                                var urldelete ='<img src="localhost:8080/finance/account/public/images/delete.png" style="width: 1.2em; height: 1.2em;">';
            
                                              $.ajax({
                                                        type: 'post',
                                                        //url: 'https://app.power2pay.com.ng/models/load_posSalesTemp.php',
                                                        url: 'http://localhost:8080/finance/account/models/load_posSalesTemp.php',
                                                        data: {subid:glid,parentid:parentid,subids:subids},
                                                        success: function (o) {
                                                            var data = JSON.parse(o);
                                                            //create table head here
                            ...
                            <div>
                                ...
                                <label>Customer</label>
                                    <select name="customers" id="customers" onchange="getvadict(this.value)">
                                    ...
                                    <input type="text" name="dcid" id=dcid>
                                    <input type="text" name="cbalance" id=cbalance>
                                    <input type="text" name="maxcreditlimit" id='maxcreditlimit'>
                                    <input type="text" name="cilosv" id='cilosv'>
