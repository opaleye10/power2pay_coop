        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Inventory : Stock Balance</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >STOCK BALANCE</div>
                                <form class="form-inline"  method="post" action="<?php echo URL . 'stockbalance/printstockbalance' ;?>"  >
                                    <div class="form-group">                                       
                                        ...
                                        <div class="form-group">
                                            <button type="submit" name="savesubglacct" id="savesubglacct" style="font-size:16px"><i class="fa fa-print"></i> Print Stock Balance </button>                                            
                                        </div>
