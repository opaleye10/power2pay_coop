                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >PROCESS SALARY FOR THE CURRENT MONTH</div>                                
                                     
                                     <center>   <div class="form-group" style="align-items: center;">
                                            <button type="submit" name="processme" id="processme" style="font-size:16px"><i class="fa fa-process"></i> Process Salary </button>                                            
                                        </div></center>


                                        <div  id="snackbar1" class="alert alert-danger" role="alert" style="text-align: center;" >Please, wait............</div>        
