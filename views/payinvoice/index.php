                                 ...
                                 <div>
                                  ...
                                  //  $myrecords=($this->GetGlAcctsubdetails);
                                    ...
                                    <table class="blueTable">
                                        ...
                                        <?php
                                            $sn=0;
                                          foreach ($this->GetAccount2pay as $Key => $Value) {
                                          	$sn=$sn+1;
                                          	$id=$Value['tme'];
                                                $link='<a href="'. URL.'payinvoice/details/'. $id.'"> <button style="font-size:12px"><i class="fa fa-pencil"></i> View </button></a>';  
                                            echo '<tr><td>'.$sn.'</td>
                                        <td>'.$Value['trndate'].'</td><td>'.$Value['supplier'].'</td><td>'.$Value['description'].'</td><td>'.$Value['trnno'].'</td><td style="text-align: right">'.number_format($Value['amt']).'</td><td>'.$link.'</td></tr>';
                                        }
