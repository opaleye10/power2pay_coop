                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >Change Password</div>
                                <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>Changepwd/changeidcode">
                                    <div class="form-group">
                                      <input type="text" class="form-control" id="oldpass" name='oldpass' placeholder="Old Password" required>
                                     </div><br/>
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="newpass" name="newpass" placeholder="New Password" required>
                                     </div> <br/>
                                     <div class="form-group">
                                    <input type="text" class="form-control" id="cnewpass" name="cnewpass" placeholder=" Confirm New Password" required>
                                     </div><br/>
                                     <div class="form-group">
                                            <button type="submit" name="" id="changepwdbutton" style="font-size:16px"><i class="fa fa-save"></i> Change Password </button>                                            
                                        </div>
