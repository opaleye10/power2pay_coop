        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Account Receivable: POS Transaction List</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert"  style="text-align: center;">POS Transaction Posting</div>
                                  ...
                                  //  $myrecords=($this->GetGlAcctsubdetails);
                                    ...
                                    <table class="blueTable">
                                        ...
                                        <?php
                                          ...
                                          foreach ($this->GetPOSAccountlist as $Key => $Value) {
                                          	$Key=$Key++;
                                          	$id=$Value['tme'];
                                                $link='<a href="'. URL.'poslist/details/'. $id.'"> <button style="font-size:15px"><i class="fa fa-pencil"></i> View </button></a>';  
                                                 $delete='<a href="'. URL.'poslist/delete/'. $id.'"> <button style="font-size:15px"><i class="fa fa-trash-alt"></i> Delete </button></a>';  
                                            echo '<tr>
                                            <td>'.$Key.'</td>
                                        <td>'.$Value['trndate'].'</td><td>'.$Value['customers'].'</td><td>'.$Value['trnno'].'</td><td>'.$Value['currentuser'].'</td><td style="text-align: right">'.number_format($Value['amount']).'</td><td>'.$link.'</td><td>'.$delete.'</td></tr>';
                                        }
