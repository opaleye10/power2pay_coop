...
Session::init();
$namount=0;
foreach ($this->GetPOSTransactionDetails as $Key => $Value) {

	$namount=$Value['amount'] + $namount;
	$customer=$Value['customers'];
	$customerid=$Value['customerid'];
	$trndate=$Value['trndate'];
	$purchasestype=$Value['purchasestype'];
        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Account Receivable: POS Transaction Details</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert">Transactions of <?php echo '  '. $customer . ' with Ref No :'. $trnno . ' dated '. $trndate . ' Created By :' . $currentuser; ?></div>
                                 ...
                                 <div>
                                  ...
                                  //  $myrecords=($this->GetGlAcctsubdetails);
                                    ...
                                    <table class="blueTable">
                                        ...
                                        <tfoot id="tfootid">
                                        <tr>
                                            <td colspan="6" style='text-align: right'><?php echo number_format($namount); ?>
                                            </td>
                                        </tr>
                                        </tfoot>
                                        <tbody id="tbodyid">
                                        <?php
                                          ...
                                          foreach ($this->GetPOSTransactionDetails as $Key => $Value) {
                                          	...
                                          	$sn=$Key+1;                                          	  
                                            echo '<tr><td style="text-align: center">'.$sn.'</td>
                                        <td style="text-align: center">'.$Value['pid'].'</td><td>'.$Value['product'].'</td><td style="text-align: right">'.number_format($Value['qty']).'</td><td style="text-align: right">'.number_format($Value['price']).'</td><td style="text-align: right">'.number_format($Value['amount']).'</td></tr>';
                                        }
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?php echo URL ;?>poslist/approvedpost">
                                        <input type="hidden" name="trnno" value="<?php echo $trnno; ?>">
                                        <input type="hidden" name="customer" value="<?php echo $customer; ?>">
                                        <input type="hidden" name="purchasestype" value="<?php echo $purchasestype; ?>">
                                        <input type="submit" name="" value="Approve and POST">
                                        </form><a href="<?php echo URL.'poslist'; ?>"><button>Back to Main</button></a>                                   	
