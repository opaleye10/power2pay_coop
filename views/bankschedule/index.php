        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Payroll : Bank Summary</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >SALARY BANK SCHEDULE REPORT
                                </div>                              
                                     
                                    <center> <div class="form-group" style="align-items: center;">
                                    <form method="post" enctype="multipart/form-data" action="<?php echo URL ;?>bankschedule/displaybankschedule">
                                        <select name="period" id='period'>
                                            <option value disabled selected>Select Period</option>
                                                 <?php
                                                foreach($this->GetPeriodList as $mod) {
                                                    ?>
                                                    <option value="<?php echo $mod["period"]; ?>"><?php echo $mod["period"]; ?></option>
                                                    <?php
                                                }
                                                ?> 

                                        </select><br/><br/>
                                            <button type="submit"  style="font-size:16px"><i class="fa fa-process"></i> Display Bank Schedule </button>                                            
                                        </div></center>
                                        </form>
