                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                ...
                                <form class="form-inline"  method="post" action="<?php echo URL . 'trialbalance/printreport' ;?>"  >                             



                                        <div class="col-md-12 form-group2 group-mail">
                                            <select name="acctperiod" id="acctperiod" onchange="getIdLoadsub(this.value)">
                                                <option value disabled selected>Select Account Peiord</option>                                    <?php
                                                foreach($this->GetAccountperiodlist as $module) {
                                                    ?>
                                                    <option value="<?php echo $module["astatus"]; ?>"><?php echo $module["yr"]; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
