                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >DETAILS TOTAL SALES REPORTS</div>                             
                                    ...
                                    <center> <div id='dailyreport' class="form-group" style="align-items: center;">
                                        ...
                                        <script>
                                            ...
                                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>salesdreport/displayreport">
                                            <input type="text" id="mainid" name="mainid">
                                            <button type="submit"  size="30" id="printdelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Display Daily Total Sales Report</button>
                                           </form></div>
