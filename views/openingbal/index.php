                    ...
                    <div class="graph-container">
                        ...
                        <div class="grid-form1">
                            ...
                            <div  id="snackbar" class="alert alert-danger" role="alert" ></div>
                                ...
                                <label><input type="checkbox" name="debtor" id="debtors">Debtors Opening Balances</label> <label><input type="checkbox" name="pickcash" id="pickcash">Cash and Bank Balances </label>
                                <br/>
                            <div id="debtor">
                                 ...
                                 <div class="col-md-12 form-group1 group-mail">
                                    <label class="control-label ">Select Revenue Code</label>

                                    <select  class="form-control"  name="gllist" id="gllist">
                                                <option value disabled selected>Select GL</option>
                                                 <?php
                                                 print_r($this->GetGLlist);
                                                foreach($this->GetGLlist as $mod) {
                                                    ?>
                                                    <option value="<?php echo $mod["accountid"]; ?>"><?php echo $mod["gldescription"]; ?></option>
                                                    <?php
                                                }
                                                ?>                                    
                                            </select>
                                ...
                                <label>Customer</label>
                                    <select  class="form-control"  name="banks" id="banks" onchange="getInfo(this.value)">
                                                <option value disabled selected>Select Cash/Bank</option>
                                                 <?php
                                                foreach($this->Getbanklist as $module) {
                                                    ?>
                                ...
                                <table  class="blueTable" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 20%; text-align: left;">S.No</th>
                                                <th style="width: 50%; text-align: center;" >Customer Name</th>
                                           ...
                                           <tfoot>
                                            <tr>
                                                <td colspan="3" id="footablbalance">
                                                </td>
                                            </tr>
                                            </tfoot>
                                            <tbody>
                                ...
                                <input type="hidden" name="trnno" id="trnno" value="<?php echo 'opbal/'.Session::get('period').'/01';?>">
                                <input type="hidden" name="tme" id="tme" value="<?php echo '0'; ?>">
