        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>General Ledger : GL Sub Account</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <script>
                                            function getIdLoadsub(val) {
                                                ...
                                                $.ajax({
                                                    type: 'post',
                                                    url: 'https://app.power2pay.com.ng/models/load_glsubacct.php',
                                                    data: {mainid: glid},
                                        ...
                                        <div class="col-md-12 form-group2 group-mail">
                                            <select name="glsubacct" id="glsubacct" onchange="getSubID(this.value)">
                                                <option value="">Select GL SUB-Head</option>
                                            </select>
                                            <script>
                                                function getSubID(val) {
                                                    // return  console.log('selected', val);
                                                    var glsubid=$('#glsubacct').val();
                                                    $('#subid').val(glsubid);
                                                    ...
                                                    $.ajax({
                                                        type: 'post',
                                                        url: 'https://app.power2pay.com.ng/models/getaccountsub.php',
                                                        data: {subid: glsubid},
                                                        success: function (o) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" size="2" name="mainid" id="mainid"  enabled="false" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword3">ID</label>
                                            <input type="hidden" class="form-control" size="2" name="subid" id="subid"  enabled="false" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword3">ID</label>
                                            <input type="text" class="form-control" size="4" name="classid" id="classid" placeholder="Code" enabled="false" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword3">ID</label>
                                            <input type="text" class="form-control"  name="classdesc" id="classdesc" placeholder="GL Account Head Description" enabled="false" required>
                                        </div>
                                        <button type="button" name="savesubglacct" id="savesubglacct" style="font-size:16px"><i class="fa fa-save"></i> Save </button>
