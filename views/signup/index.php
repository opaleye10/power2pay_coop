    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    <a href="<?php echo URL.'profile' ?>">Settings</a>
                    <i class="fa fa-angle-right"></i>
                    <span>Add Users <i class="fa fa-users" aria-hidden="true"></i></span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                            ...
                            <div class="col-md-12 form-group2 group-mail">
                                    ...
                                    <div class="col-md-6 form-group1 form-last">
                                        ...
                                        <div class="col-md-6 form-group1">
                                           <select name="staff" id="staff"  onchange="getStaff(this.value)">
                                                <option value disabled selected>Select Staff</option>
                                                <?php
                                                foreach($this->GetStafflist as $staff) {
                                                      ?>

                                                    <option value="<?php echo $staff["staffid"]; ?>"><?php echo $staff["fname"] .' '.$staff["mname"].' '. $staff["lname"]; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-12 form-group1 group-mail">
                                        <input type="password" name="mypwd" id="mypwd" placeholder="password" required="">
                                    </div>
                                    <div class="col-md-12 form-group1 group-mail">
                                        <input type="password" name="mypwd1" id="mypwd1" placeholder="Confirm password" required="">
                                    </div>
                                ...
                                <select name="approle" id="approle"  onchange="getRole(this.value)">
                                ...
                                <button id="createuser" class="btn btn-default btn-send"><i class="fa fa-user-plus" aria-hidden="true"></i> Create User</button>
                            </div>
                            <div class="clearfix"> </div>
            ...
            <div>
                <table class="blueTable">
                    ...
                    <?php
                        foreach ($this->GetRegisteredUsers as $key => $value) {
                        ...
                        <img src='. URL.'public/images/edit.png style="width: 6%; height: auto;">


                        </td><td>'.$value['username'].'</td><td>'.$value['rolename'].'</td><td>'.$value['roledesc'].'</td></tr>
