        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>General Ledger : Account Head Reports</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >GL ACCOUNT HEAD REPORTS</div>                             
                                     


                                     
                                <label><input type="checkbox" name="daterangepick" id="daterangepick">Date Option</label> <label><input type="checkbox" name="allperiodpick" id="allperiodpick">Whole Active Account Period </label>
                                <br/>
                            <div id="daterange"> 
                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>aheadreport/detailsdaterange">

                                    From : <input type="date" name="dfrom" id="dfrom"  size="13"  ng-model="model.date" required="">
                                    To: <input type="date" name="dto" id="dto"  size="13"  ng-model="model.date" required="">
                                    <br/><br/>
                                    <select name="glaccount" id="glaccount">
                                            <option value disabled selected>GL Account Head</option>                                    <?php
                                            foreach($this->GetGLAccountHead as $module) {
                                                ?>
                                                <option value="<?php echo $module["accountid"]; ?>"><?php echo  $module["gldescription"]. ' ------------  '. $module["accountid"]; ?></option>
                                                <?php
                                            }
                                            ?>
                                            </select><br/><br/>
                                <input type="submit" name="" value="Display Report">  
                                 </form>                               
                                </div>

                                <div id="allperiod">
                                <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>aheadreport/detailsperiod">
                                    <select  class="form-control"  name="speriod" id="speriod" onchange="getInfo(this.value)">
                                                <option value disabled selected>Select Period</option>
                                                 <?php
                                                foreach($this->GetAccountperiodlist as $module) {
                                                    ?>
                                                    <option value="<?php echo $module["yr"]; ?>"><?php echo $module["yr"]; ?></option>
                                                    <?php
                                                }
                                                ?>                                    
                                            </select>
                                            <select name="glaccount4period" id="glaccount4period">
                                            <option value disabled selected>GL Account Head</option>                                    <?php
                                            foreach($this->GetGLAccountHead as $module) {
                                                ?>
                                                <option value="<?php echo $module["accountid"]; ?>"><?php echo  $module["gldescription"]. ' ------------  '. $module["accountid"]; ?></option>
