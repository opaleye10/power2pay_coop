                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                <div  id="snackbar" class="alert alert-danger" role="alert" style="text-align: center;" >DETAILS SALES RECEIPT</div>                             
                                        <label style="font-size: .9em; color: #800000"><input type="checkbox" name="daily" id="daily"> Daily Report </label>     <label style="font-size: .9em; color: #800000"><input type="checkbox" name="daterange" id="daterange"> Date Range Report </label>


                                    <center> <div id='dailyreport' class="form-group" style="align-items: center;">
                                    
                                             <div class="col-md-12 form-group2 group-mail">
                                            
                                            <input type="date"  id="currentdate" name="currentdate" ng-model="model.date" required="" onchange="getIdLoadsub(this.value)">
                                        ...
                                        <script>
                                            function getIdLoadsub(val) {
                                                ...
                                                var glid = document.getElementById("currentdate").value;
                                                $('#mainid').val(glid);
                                                
                                               
                                            }
                                        </script> 
                                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>salessummary/dailysalessummary">
                                            <input type="hidden" id="mainid" name="mainid">
                                            <button type="submit"  size="30" id="printdelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Display Daily Sales Summary Report</button>
                                           </form></div>

                                           <?php
                                          // echo date('Y-m-d', strtotime("+2 week")); //1 week in the future
                                           ...
                                           <div id='daterangereport' class="form-group" style="align-items: center;">
                                    
                                             <div class="col-md-12 form-group2 group-mail"> From :
                                            <input type="date"  id="currentdate" name="currentdate" ng-model="model.date" required="" onchange="getIdLoadsub1(this.value)"> To : 
                                            <input type="date"  id="currentdate" name="currentdate" ng-model="model.date" required="" onchange="getIdLoadsub1(this.value)">

                                        </div>
                                        <br/>
                                        <script>
                                            function getIdLoadsub1(val) {
                                                // return  console.log('selected', val);
                                                var glid = document.getElementById("possales").value;
                                                $('#mainid1').val(glid);
                                               
                                            }
                                        </script> 
                                            <form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>ar_sdr/printreceipt">
                                            <input type="hidden" id="mainid1" name="mainid1">
                                            <button type="submit"  size="30" id="printdelivery" class="btn btn-default"> <i class="fa fa-print" aria-hidden="true"></i> Display Date-Range Report</button>
                                           </form></div>
                                            </center>
