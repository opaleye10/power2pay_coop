        ...
        <div class="content-main">
            ...
            <div class="banner">
                ...
                <h2>
                    ...
                    <span>Accounting Period : Edit</span>
                </h2>
            </div>
            <!--//banner-->
            <!--content-->
                    ...
                    <div class="content-graph">
                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                ...
                                <form class="form-inline" method="post" enctype="multipart/form-data" action="<?php echo  URL. 'acctyr/edit' ;?>">
                                    <div class="form-group">
                                        <div class="col-md-12 form-group2 group-mail">
                                            <div class="form-group">
                                                <label class="control-label ">Start Date</label>
                                                <input type="date" name="start_date" id="start_date" value="<?php echo $this->GetAcctYr['startdate'] ;?>" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label ">Start Date</label>
                                                <input type="date" name="end_date" id="end_date" value="<?php echo $this->GetAcctYr['enddate'] ;?>" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 form-group2 group-mail">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" size="67" value="<?php echo $this->GetAcctYr['yr'] ;?>"  name="actualyr" id="actualyr" placeholder="Account Year" enabled="false" required>
                                                <input type="text" class="form-control" size="67" value="<?php echo $this->GetAcctYr['id'] ;?>"  name="myid" id="myid" placeholder="Account Year" enabled="false" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <select name="astatus" id="astatus" col="60" >
                                                <option value="<?php echo $this->GetAcctYr['yr'] ;?>"><?php echo $this->GetAcctYr['astatus'] ;?></option>
                                        ...
                                        <button type="submit" name="EditAcctYear" id="EditAcctYear" class="btn btn-default">Edit</button>
                                    </div>
                                </form>
