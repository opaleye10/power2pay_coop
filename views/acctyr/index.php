                        ...
                        <div class="graph-container">
                            <div class="grid-form1">
                                ...
                                <form class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="start_date" id="start_date" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label ">Start Date</label>
                                            <input type="date" name="end_date" id="end_date" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" size="67"  name="actualyr" id="actualyr" placeholder="Account Year" enabled="false" required>
                                        </div>
                                        </div>
                                        ...
                                        <button type="button" name="SaveAcctYear" id="SaveAcctYear" class="btn btn-default">Save</button>
                                    </div>
                                </form>

                                <script>
                                    function getGlhead(val) {
                                        // return  console.log('selected', val);
                                        $("#tbodyid").empty();
                                        var glid = document.getElementById("glmainacct").value;
                                        $('#mainid').val(glid);
                                        // alert(glid);
                                        // $('#snackbar').show();
                                        ...
                                        $.ajax({
                                            type: 'post',
                                            url: 'http://localhost:8080/finance/account/models/getaccounthead.php',
                                            data: {mainid: glid},
                                            success: function (o) {
                                                ...
                                                {
                                                    var createrow = "<tr><td>" + data[i].mainid + "</td><td>" + data[i].subid + "</td><td>" + data[i].sub_desc + "</td></tr>";
                                                    $("table tbody").append(createrow);

                                                    //$('#snackbar').append(data[i].sub_desc);
                                                    // $('#snackbar').html(o);
                                                    //  $('#snackbar').html(data);
                                                }
                                ...
                                <div>
                                    ...
                                    $myrecords=($this->GetAccountperiodlist);
                                    ?>
                                    <table class="blueTable">
                                        ...
                                        <?php
                                          ...
                                          echo '<tr>
                                             <td>'.$Value['startdate'].'</td><td>'.$Value['enddate'].'</td><td>'.$Value['yr'].'</td><td>'.$Value['astatus'].'</td><td><a href=' . URL . 'acctyr/editacctyr/' . $Value['id'] . '><button>Edit</button></a> </td></tr>';
                                        }
