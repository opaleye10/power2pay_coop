...
class Reorderlevel extends Controller{
    function __construct()
    {
        parent::__construct();
        Session::init();
        $this->view->js=array('reorderlevel/js/default.js');
    ...
    function index(){                
        ...
        $this->view->Getitem2reorder =$this->model->Getitem2reorder();
        $this->view->render('reorderlevel/index');
    }
