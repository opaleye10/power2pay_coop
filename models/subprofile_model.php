...
class Subprofile_Model extends Model
{
    ...
    public function SaveSubProfile($data)
    {
        $sth=$this->db->prepare("INSERT INTO tbl_subfirm (parentid,subfirm,contact) VALUES(:parentid,:subfirm,:contact)");
        $sth->execute(array(
            ':parentid'=>$data['parentid'],
            ':subfirm'=>$data['subfirm'],
            ':contact'=>$data['contact']
            ));
    	echo "Subsidiary of the Main Company successfully Saved";
    }
